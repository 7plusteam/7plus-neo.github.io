# <a href="repository.7Plus.zip">DOWNLOADDO REPOSITÓRIO</a>
...
<p align="left">
  <ul>
    ...
    <li>O endereço para a fonte é <code>https://tinyurl.com/7plusneotv</code> (Dar o nome de "repository.7Plus").</li>
